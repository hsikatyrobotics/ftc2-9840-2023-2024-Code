...
public class shortBlueAuto extends OpMode {
    ...
    public void loop() {
        ...
        if(position.equals("right")){
            TrajectorySequence right1 = drive.trajectorySequenceBuilder(new Pose2d(10, 62, Math.toRadians(270)))
                    .forward(28)
            ...
            TrajectorySequence right2 = drive.trajectorySequenceBuilder(new Pose2d(10, 34, Math.toRadians(180)))
                    .back(35)
                    .build();
        ...
        if(position.equals("middle")){
            TrajectorySequence middle1 = drive.trajectorySequenceBuilder(new Pose2d(10, 62, Math.toRadians(270)))
                    .forward(28)
                    .build();
            ...
            TrajectorySequence middle2 =  drive.trajectorySequenceBuilder(new Pose2d(10, 34, Math.toRadians(270)))
                    .back(4)
                    .turn(Math.toRadians(-90))
                    .back(35)
                    .build();
        ...
        if(position.equals("left")){
            TrajectorySequence left1 = drive.trajectorySequenceBuilder(new Pose2d(10, 62, Math.toRadians(270)))
                    .splineTo(new Vector2d(32,32), Math.toRadians(180))
                    .build();
            ...
            TrajectorySequence left2 = drive.trajectorySequenceBuilder(new Pose2d(32, 32, Math.toRadians(180)))
                    .back(14)
                    .build();
